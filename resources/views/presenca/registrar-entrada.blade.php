        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('presenca.salvar-entrada', $crianca) }}" method="POST">
                        @csrf

                        <div class="mb-4">
                            <label for="responsavel_entrada_id" class="block text-sm font-medium text-gray-700">Responsável pela entrega</label>
                            <select name="responsavel_entrada_id" id="responsavel_entrada_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>
